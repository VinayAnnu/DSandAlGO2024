package DesignPattern.StateDesignPattern.VendingMachine.VendingStates.impl;

import DesignPattern.StateDesignPattern.VendingMachine.Coin;
import DesignPattern.StateDesignPattern.VendingMachine.Item;
import DesignPattern.StateDesignPattern.VendingMachine.VendingMachine;
import DesignPattern.StateDesignPattern.VendingMachine.VendingStates.State;
...
public class SelectionState implements State {
    ...
    public void chooseProduct(VendingMachine machine, int codeNumber) throws Exception{
        ...
        if(paidByUser < item.getPrice()) {
            ...
            List<Coin> fullAmount = refundFullMoney(machine);
            fullAmount.forEach(x-> System.out.println("COIN returned to USER "+x.value));
    ...
    public List<Coin> refundFullMoney(VendingMachine machine) throws Exception{
        List<Coin> fullAmount = machine.getCoinList();
